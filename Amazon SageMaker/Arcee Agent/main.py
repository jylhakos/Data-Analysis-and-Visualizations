...
Usage:
    ...
    poetry run python main.py --model arcee-ai/Arcee-Agent --base_url http://localhost:8000/v1 --api_key dummy
    ...
    poetry run python main.py --model arcee-ai/Arcee-Agent --base_url https://your-sagemaker-endpoint.amazonaws.com/v1 --api_key YOUR_API_KEY
