...
with automatic resource optimization based on available GPU memory.
...
Usage:
    # Basic fine-tuning
    python fine_tune_arcee.py --dataset-path ./dataset --output-dir ./fine_tuned_models
    
    # Memory-constrained training
    python fine_tune_arcee.py --dataset-path ./dataset --max-length 1024 --lora-r 8
    
    # High-performance training
    python fine_tune_arcee.py --dataset-path ./dataset --no-quantization --lora-r 32
"""
